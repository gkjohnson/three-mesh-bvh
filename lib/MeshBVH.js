...
import  Utilies from './GeometryUtilities.js'
const { getBufferGeometryVertexElem, getGeometryVertexElem, getLongestEdgeIndex, getAverage, shrinkBoundsTo, shrinkSphereTo } = Utilies;
...
class MeshBVH {
    ...
    /* Public API */
    collectCandidates(origray) {
        return this._root.collectCandidates(origray);
    }
