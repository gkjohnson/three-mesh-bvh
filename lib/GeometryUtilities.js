...
const intersectTris = ( mesh, geo, raycaster, ray, tris, offset, count, intersections, seenFaces ) => {
...
const intersectClosestTri = ( mesh, geo, raycaster, ray, tris, offset, count ) => {
