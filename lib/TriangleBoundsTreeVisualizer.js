...
const wiremat = new THREE.MeshBasicMaterial({ color: 0x00FF88, wireframe: true, wireframeLinewidth: 1, transparent: false, opacity: 0.3 });

class TriangleBoundsTreeVisualizer extends THREE.Object3D {
...
export default TriangleBoundsTreeVisualizer;