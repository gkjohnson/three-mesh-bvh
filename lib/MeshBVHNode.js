...
class MeshBVHNode {
	...
	raycast( mesh, raycaster, ray, intersects, seenFaces ) {
		...
		if ( this.count ) intersectTris( mesh, this.geometry, raycaster, ray, this.offset, this.count, intersects, seenFaces );
	...
	raycastFirst( mesh, raycaster, ray ) {
		...
		if ( this.count ) {
			...
			return intersectClosestTri( mesh, this.geometry, raycaster, ray, this.offset, this.count );
