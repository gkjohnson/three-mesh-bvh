...
class MeshBVHNode {
	...
	raycast( mesh, raycaster, ray, intersects, seenFaces ) {
		...
		if ( this.tris ) intersectTris( mesh, this.geometry, raycaster, ray, this.tris, this.offset, this.count, intersects, seenFaces );
	...
	raycastFirst( mesh, raycaster, ray ) {
		...
		if ( this.tris ) {
			...
			return intersectClosestTri( mesh, this.geometry, raycaster, ray, this.tris, this.offset, this.count );
