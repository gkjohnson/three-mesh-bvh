...
export class MeshBVH {
	...
	shiftTriangleOffsets( offset ) {
		...
		if ( indirectBuffer ) {
			...
			// with indirect=true the leaf nodes reference the indirect buffer, so we only
			...
			// with indirect=false the leaf nodes reference the geometry directly, so we need
