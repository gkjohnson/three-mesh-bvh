import{H as e,Ht as t,Y as n,Yr as r,b as i,f as a,gr as o,o as s,on as c,p as l,pn as u,rr as d}from"./ExtendedTriangle-DOKLf4jx.js";import{t as f}from"./Pass-WYNZO8G0.js";import{t as p}from"./lil-gui.module.min-CCk8J1jY.js";import{t as m}from"./GLTFLoader-p6qoQbZ1.js";import{t as h}from"./OrbitControls-BX2ddTIw.js";import{t as g}from"./meshopt_decoder.module-DDLmvpjg.js";import{t as _}from"./stats.module-BDErWxYO.js";import{C as v,_ as y,a as b,b as x,c as S,d as C,h as w,l as T,m as E,p as D,s as O,t as k,x as A}from"./BVHComputeData-BmCxIjcA.js";var j=class extends x{constructor(e){super();let n={surface:D(0),normalStep:D(new r),projectionInverse:D(new t),sdfTransformInverse:D(new t),sdfTransform:D(new t),uv:w(E()),sdf_sampler:S(e),sdf:C(e)},i=y(`
		...
		`)]);this.fragmentNode=i(n);let a={position:O},o=y(`

			fn noop(position: vec4f) -> vec4f {
				return position;
			}

		`);this.vertexNode=o(a)}},M=class extends x{constructor(e){super();let t=y(`
		...
		`),n={layer:D(0),grid_mode:D(!1),uv:w(E()),sdf_sampler:S(e),sdf:C(e)},r=y(`
			fn layer(
				layer: u32,
				grid_mode: bool,
...
//# sourceMappingURL=webgpu_sdfGeneration-DB8nV_7a.js.map