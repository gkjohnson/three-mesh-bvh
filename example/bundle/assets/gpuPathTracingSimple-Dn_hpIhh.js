import{W as h,c as M,D as x,A as g,P as b,T as y,M as S,g as P,S as H,n as l,h as O}from"./ExtendedTriangle-ChbiCwBo.js";import{O as W}from"./OrbitControls-DHySDY8x.js";import{F as R}from"./Pass-BA5ZEirR.js";import{S as A}from"./stats.min-DbzWzcqd.js";import{g as C}from"./lil-gui.module.min-BH_YJbPT.js";import{M as _,S as D}from"./MeshBVH-C3oPApeN.js";import{c as F,b as j,a as L}from"./bvh_struct_definitions.glsl-D9u392Ar.js";import{F as N,M as T}from"./MeshBVHUniformStruct-6-HcyJKV.js";import"./_commonjsHelpers-CqkleIqs.js";const r={enableRaytracing:!0,animate:!0,resolutionScale:1/window.devicePixelRatio,smoothNormals:!0};let e,i,o,n,u,d,s,f;z();w();function z(){e=new h({antialias:!1}),e.setPixelRatio(window.devicePixelRatio),e.setClearColor(594970),e.setSize(window.innerWidth,window.innerHeight),e.outputEncoding=void 0,document.body.appendChild(e.domElement),o=new M;const a=new x(16777215,1);a.position.set(1,1,1),o.add(a),o.add(new g(11583173,.5)),i=new b(75,window.innerWidth/window.innerHeight,.1,50),i.position.set(0,0,4),i.far=100,i.updateProjectionMatrix(),u=new A,document.body.appendChild(u.dom);const t=new y(1,.3,300,50),c=new _(t,{maxLeafTris:1,strategy:D});s=new S(t,new P),o.add(s),f=new O;const m=new H({defines:{SMOOTH_NORMALS:1},uniforms:{bvh:{value:new T},normalAttribute:{value:new N},cameraWorldMatrix:{value:new l},invProjectionMatrix:{value:new l},invModelMatrix:{value:new l}},vertexShader:`
...
//# sourceMappingURL=gpuPathTracingSimple-Dn_hpIhh.js.map
