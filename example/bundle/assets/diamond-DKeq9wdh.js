import{a1 as ne,H as W,F as X,a2 as V,a3 as te,L as q,c as ie,P as oe,W as le,a4 as ce,a5 as se,a6 as me,S as de,J as fe,C as he,M as pe,h as ve}from"./ExtendedTriangle-CFC-kWKu.js";import{g as ge}from"./lil-gui.module.min-jESndyO-.js";import{O as ue}from"./OrbitControls-DPxOa-V_.js";import{G as ye}from"./GLTFLoader-C_LgBif7.js";import{M as we,S as _e}from"./MeshBVH-Cf1Esfgv.js";import{M as be}from"./MeshBVHUniformStruct-C4k4y6pH.js";import{c as Re,b as Me,a as Ee}from"./bvh_struct_definitions.glsl-SZg5BxSQ.js";import"./BufferGeometryUtils-e7tZihaS.js";class De extends ne{constructor(c){super(c),this.type=W}parse(c){const e=function(r,n){switch(r){case 1:throw new Error("THREE.RGBELoader: Read Error: "+(n||""));case 2:throw new Error("THREE.RGBELoader: Write Error: "+(n||""));case 3:throw new Error("THREE.RGBELoader: Bad File Format: "+(n||""));default:case 4:throw new Error("THREE.RGBELoader: Memory Error: "+(n||""))}},f=`
