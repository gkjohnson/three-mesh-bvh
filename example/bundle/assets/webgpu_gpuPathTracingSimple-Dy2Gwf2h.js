import{ai as _,c as k,D as L,A as V,P as z,T as B,M as D,g as F,V as W,n as H,a0 as U,av as j,L as G,h as K}from"./ExtendedTriangle-ChbiCwBo.js";import{w as p,i as Q,r as y,b as Y,a as w,c as R,W as Z,S as f,u as v,s as g,t as q,n as J,g as X,l as $,d as ee,v as te,M as re,e as M,f as oe,h as ie,j as ae}from"./common_functions.wgsl-CWMnPyYc.js";import{O as se}from"./OrbitControls-DHySDY8x.js";import{F as ne}from"./Pass-BA5ZEirR.js";import{S as de}from"./stats.module--VATS4Kh.js";import{g as le}from"./lil-gui.module.min-BH_YJbPT.js";import{M as ce,S as ue}from"./MeshBVH-C3oPApeN.js";const me=p(`
...
`,[pe,Q,y,Y,w,R]),a={enableRaytracing:!0,animate:!0,resolutionScale:1/window.devicePixelRatio,smoothNormals:!0};let e,r,c,n,b,E,m,O,u,s,t,P=[];const x=[8,8,1];ve();function ve(){e=new Z({canvas:document.createElement("canvas"),antialias:!0,forceWebGL:!1}),e.setAnimationLoop(ge),e.setPixelRatio(window.devicePixelRatio),e.setClearColor(594970),e.setSize(window.innerWidth,window.innerHeight),e.outputColorSpace=_,document.body.appendChild(e.domElement),c=new k;const i=new L(16777215,1);i.position.set(1,1,1),c.add(i),c.add(new V(11583173,.5)),r=new z(75,window.innerWidth/window.innerHeight,1,10),r.position.set(0,0,4),r.updateProjectionMatrix(),b=new de,document.body.appendChild(b.dom);const o=new B(1,.3,300,50),d=new ce(o,{maxLeafTris:1,strategy:ue});m=new D(o,new F),c.add(m),O=new K;const l=new f(o.index.array,3),I=new f(o.attributes.position.array,3),T=new f(o.attributes.normal.array,3),S=new f(new Float32Array(d._roots[0]),8),A={outputTex:q(t),smoothNormals:v(1),inverseProjectionMatrix:v(new H),cameraToModelMatrix:v(new H),geom_index:g(l,"uvec3",l.count).toReadOnly(),geom_position:g(I,"vec3",I.count).toReadOnly(),geom_normals:g(T,"vec3",T.count).toReadOnly(),bvh:g(S,"BVHNode",S.count).toReadOnly(),workgroupSize:v(new W),workgroupId:ee,localId:$};s=p(`
	...
	`,[N]);u=new re,u.positionNode=C({position:M("position"),uv:M("uv")}),u.colorNode=oe(ie(t,N),_),E=new ne(u),new se(r,e.domElement),n=new le,n.add(a,"enableRaytracing"),n.add(a,"animate"),n.add(a,"smoothNormals"),n.add(a,"resolutionScale",.1,1,.01).onChange(h),n.open(),window.addEventListener("resize",h,!1),h()}function h(){const i=window.innerWidth,o=window.innerHeight,d=window.devicePixelRatio,l=a.resolutionScale;r.aspect=i/o,r.updateProjectionMatrix(),e.setSize(i,o),e.setPixelRatio(d),t&&t.dispose(),t=new ae(i*d*l,o*d*l),t.format=U,t.type=j,t.magFilter=G}function ge(){b.update();const i=O.getDelta();a.animate&&(m.rotation.y+=i),a.enableRaytracing?(P=[Math.ceil(t.width/x[0]),Math.ceil(t.height/x[1])],r.updateMatrixWorld(),m.updateMatrixWorld(),s.computeNode.parameters.outputTex.value=t,s.computeNode.parameters.smoothNormals.value=Number(a.smoothNormals),s.computeNode.parameters.inverseProjectionMatrix.value=r.projectionMatrixInverse,s.computeNode.parameters.cameraToModelMatrix.value.copy(m.matrixWorld).invert().multiply(r.matrixWorld),s.computeNode.parameters.workgroupSize.value.fromArray(x),e.compute(s,P),u.colorNode.colorNode.value=t,E.render(e)):e.render(c,r)}
//# sourceMappingURL=webgpu_gpuPathTracingSimple-Dy2Gwf2h.js.map
